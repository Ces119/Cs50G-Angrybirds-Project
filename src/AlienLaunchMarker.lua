...
function AlienLaunchMarker:addAlien()
    for i = 1, 2 do 
        ...
        if i % 2 == 0 then 
            alien.body:setLinearVelocity((self.baseX - self.shiftedX) * 10, (self.baseY - self.shiftedY - 10) * 7)
        else 
            alien.body:setLinearVelocity((self.baseX - self.shiftedX) * 10, (self.baseY - self.shiftedY + 10) * 2)
        end 
